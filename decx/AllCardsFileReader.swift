...
class AllCardsFileReader {
  ...
  init(pathToFile: String) {
    ...
    json = NSJSONSerialization.JSONObjectWithData(reader.contents().dataUsingEncoding(NSUTF8StringEncoding)!, options: nil, error: &jsonError) as! NSDictionary?
    if (jsonError != nil) {
      error = true
      if (jsonError != nil) {
